...
<head>
    ...
    <title>{{$warehouse->property->name}} - Tobio Properties</title>
...
<body>
        ...
        <div class="column profileback">
            <div class="containerx">
                <div class="carousel carousel-main" data-flickity='{"pageDots": false }'>
                    ...
                    <div class="carousel-cell"><img src="/uploads/property/warehouse/{{$image}}" /></div>
                    @endforeach
        ...
        <div class="containerx detailssection">
            <div class="columns is-flex-mobile">
                <div class="column is-two-thirds is-flex-mobile">
                    <div class="containerx">
                        <a href="/warehouse/{{$warehouse->id}}/favorite" class="button is-danger is-pulled-right"><span><i class="far fa-heart"></i></span></a>
            ...
            <div class="column is-flex-mobile">
                <form action="/warehouse/{{$warehouse->id}}/contactowner" method="post">
                    @csrf
                    <div class="field">
                            <div class="control">
            ...
            <div class="notification is-danger">
                ...
                <strong>Important information:</strong> This ad has been posted on Tobio Properties by the above mentioned
                advertiser. Tobio Properties does not have any connection with this advertiser, nor do we vet the advertisers,
                guarantee their services, responsible for the accuracy of the ad's content or are responsible for services
                provided by the advertisers. Tobio Properties does not provide any service other than list the advertisements
    ...
    @include('layouts.reportwarehouse')
    {{-- JavaScript Files --}}

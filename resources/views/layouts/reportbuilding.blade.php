<div class="modal repo" id="reportModal">
  ...
  <div class="modal-card">
    ...
    <section class="modal-card-body">
      <form action="/building/{{$building->id}}/report" method="post">
        @csrf
        <div class="field">
    ...
    <footer class="modal-card-foot is-centered has-text-centered">
      <p class="subtitle is-7 has-text-centered" style="margin-left: 12%;">Thank you for your report, our staff will look into this report and take further actions. <br> <strong>Tobio Properties - Leader in Real Estate Business</strong></p>
    </footer>
  </div>
</div>

...
Route::get('/land/search','PageController@landsearch');
...
Route::get('/building/search','PageController@buildingsearch');
...
Route::get('/apartment/search','PageController@apartmentsearch');
...
Route::get('/warehouse/search','PageController@warehousesearch');
